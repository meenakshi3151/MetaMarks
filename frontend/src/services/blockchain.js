...
// Placeholder addresses and ABIs; replace with deployed contract details
export const CONTRACTS = {
  registry: {
    address: process.env.REACT_APP_REGISTRY_ADDRESS || '0x0000000000000000000000000000000000000000',
    abi: [],
  },
};
